            ...
            <div style={{textAlign:'center'}}>
                <div className="container">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md" >
                        <div className="card-body" style={{textAlign:'left'}}>
                          <h5 className="card-title" style={{color:'green'}} onClick={()=>window.location.href='/searchResult'}>Shadman Banquet</h5>
                  ...
                  <div className="col-md-5 " >
                    <div className="row">
                      ...
                      <div className="col-md" >
                        <div className="card-body" style={{textAlign:'left'}}>
                          <h5 className="card-title" style={{color:'green'}} onClick={()=>window.location.href='/searchResult'}>Taj Banquet</h5>
                ...
                <div className="container my-4">
                    ...
                    <div className="row ">
                      ...
                      <div className="col-md">
                        <div className="card-body" style={{textAlign:'left'}}>
                          <h5 className="card-title" style={{color:'green'}} onClick={()=>window.location.href='/searchResult'}>Caspia Banquet</h5>
                  ...
                  <div className="row ">
                    ...
                    <div className="col-md">
                      <div className="card-body" style={{textAlign:'left'}}>
                        <h5 className="card-title" style={{color:'green'}} onClick={()=>window.location.href='/searchResult'}>Lovely Lawn</h5>
                        <h5 className="card-title" style={{color:'red'}}>50% OFF</h5>
